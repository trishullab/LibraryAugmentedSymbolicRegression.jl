...
@testitem "Variable names - single outputs" tags = [:online] begin
    using LibraryAugmentedSymbolicRegression
...
@testitem "Variable names - named outputs" tags = [:online] begin
    using LibraryAugmentedSymbolicRegression
    using MLJBase
    using Random: MersenneTwister
...
@testitem "Good predictions" tags = [:online] begin
    using LibraryAugmentedSymbolicRegression
    using MLJBase
    using Random: MersenneTwister
...
@testitem "Helpful errors" tags = [:online] begin
    using LibraryAugmentedSymbolicRegression
    using MLJBase
    using Random: MersenneTwister
...
@testitem "Unfinished search" tags = [:online] begin
    using LibraryAugmentedSymbolicRegression
    using MLJBase
    using Suppressor
    using Random: MersenneTwister
